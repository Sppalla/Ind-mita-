...
export default function App() {
  ...
  return <main>
    ...
    <section id="inicio" className="hero"><div className="hero-copy"><h1>Moda que acompanha<br/>o seu <em>movimento.</em></h1><p>Caimento refinado que vai além do treino, para você viver e sentir-se inteira em cada presença.</p><a className="cta" href="#colecao">Explorar a coleção</a></div><div className="hero-art" aria-hidden="true"><img className="hero-mark" src="/logo-mark.png" alt="" /></div></section>
    ...
    <footer><a className="logo" href="#inicio">indómita<sup>®</sup></a><p>Moda fitness para o seu movimento.</p><a href="https://www.instagram.com/vestir.indomita?stkn=MW83bml5cWcwb215Mg==" target="_blank" rel="noreferrer">Instagram</a></footer>
  </main>
}